...
app.get('/productData', (req, res) => {
    ...
    let categoryId = Number(req.query.categories);
    let priceId = Number(req.query.prices)
    if (stateId) {
        query = { State_id: stateId };
    } else if (categoryId) {
        query = { categories: categoryId }
    } else if (priceId) {
        query = { prices: priceId }
    }
...
app.get('/price', (req, res) => {
    let query = {};
    let stateId = Number(req.query.State_id);
    let listId = Number(req.query.list_id); let priceId = Number(req.query.prices)
    if (stateId) {
        query = { State_id: stateId }
    }
    if (listId) {
...
app.get('/productLists', (req, res) => {
    ...
    let categoriesId = Number(req.query.categories);
    if (stateId) {
        query = { State_id: stateId }
    } else if (categoryId) {
        query = { Category_id: categoryId }
    } else if (categoriesId) {
        query = { categories: categoriesId }
    }
